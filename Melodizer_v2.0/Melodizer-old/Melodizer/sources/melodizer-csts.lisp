...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; MINIMUM-PITCH constraint ;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

; <sp> is the space
; <notes> is a list of IntVars representing the pitch of the notes
; ensures that the minimum pitch of a note is a determined value
(defun minimum-pitch (sp notes min-pitch)
    (gil::g-lmin sp (gil::add-int-var sp (parse-integer min-pitch) 200) notes)
)


;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; MAXIMUM-PITCH constraint ;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

; <sp> is the space
; <notes> is a list of IntVars representing the pitch of the notes
; ensures that the maximum pitch of a note is a determined value
(defun maximum-pitch (sp notes max-pitch)
    (gil::g-lmax sp (gil::add-int-var sp 0 (parse-integer max-pitch)) notes)
)
